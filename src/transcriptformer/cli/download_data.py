...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--species",
        required=True,
        help="Comma-separated list of species to download"
    )
    parser.add_argument(
        "--output-dir",
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help="Maximum retry attempts per dataset"
    )
    parser.add_argument(
        "--no-metadata",
        action="store_true",
        help="Skip saving dataset metadata"
    )
    parser.add_argument(
        "--test-only",
        action="store_true",
        help="Only test API connectivity, don't download"
    )
